...
flags.DEFINE_string('classes', './data/labels/classes.txt', 'path to classes file')
flags.DEFINE_string('weights', './weights/yolov3-custom.tf',
                    'path to weights file')
flags.DEFINE_boolean('tiny', False, 'yolov3 or yolov3-tiny')
flags.DEFINE_integer('size', 416, 'resize images to')
flags.DEFINE_string('video', './data/video/unprocessed.mp4',
                    'path to video file or number for webcam)')
flags.DEFINE_string('output','./data/video/abc.avi', 'path to output video')
